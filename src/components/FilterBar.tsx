...
import { Search, Filter, RotateCcw, AlertTriangle, Building, UserCheck } from 'lucide-react';
...
export const FilterBar: React.FC<FilterBarProps> = ({
  ...
  return (
    <div className="bg-[#111724] border border-slate-800 rounded-2xl p-4 shadow-xl">
